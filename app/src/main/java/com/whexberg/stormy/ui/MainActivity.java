...
import com.whexberg.stormy.weather.Current;
import com.whexberg.stormy.weather.Day;
import com.whexberg.stormy.weather.Forecast;
import com.whexberg.stormy.weather.Hour;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void getForecast(double latitude, double longitude) {
        String apiKey = "5cdd9f40ff33077c7de6c010b9ab7fb6";
        ...
        if(isNetworkAvailable()) {
            ...
            call.enqueue(new Callback() {
                ...
                public void onFailure(Request request, IOException e) {
                    ...
                    alterUserAboutError( // alert general error
            ...
            alterUserAboutError( // alert network error
    ...
    private void alterUserAboutError(String title, String message, String buttonText) {
